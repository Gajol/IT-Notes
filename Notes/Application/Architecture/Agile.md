...
- inspection: the Scrum artifacts and the progress twoard agreed goals must be inspected frequently. (5 events???)
...
# Six Sigma (Motorola)
- receipient of [MBNQA award 1998](https://en.wikipedia.org/wiki/Malcolm_Baldrige_National_Quality_Award#Baldrige_Award_Recipients)
- [Six Sigma Overview](https://pecb.com/article/six-sigma-a-case-study-in-motorola)

# Lean Six Sigma
[Lean Six Sigma](https://en.wikipedia.org/wiki/Lean_Six_Sigma) is a method that relies on a collaborative team effort to improve performance by systematically removing waste[1] and reducing variation.

It combines lean manufacturing/lean enterprise and Six Sigma to eliminate the eight kinds of waste (muda):
...
Learning Points: [ref: IsixSigma](https://www.isixsigma.com/community/blogs/ellen-bovarnick-nortel-networks/).  
...
[Lean Six Sigma - O'Reilly - Leading Holistic Improvement](https://learning.oreilly.com/library/view/leading-holistic-improvement/9780134299662/) - ISBN 978-0-13-428888-8

Limitations of early Lean Six Sigma:  ( I guess O'Reilly book offers solutoin...)
...
[GE - Jack Welch - One Distastrous Mistake](https://www.forbes.com/sites/steveforbes/2020/03/03/jack-welch-managerial-genius-who-made-one-disastrous-mistake/?sh=57d2f7843749) - Answer: Who he picked as his successor.  Successor's lost a lot of money in the 2008 economic crises, and GE did not adapt to high-tech (unlike how it adapted to new financial instruments to transition from industrialization to financial markets with GE Capital).
- [Jack Welch - Six Secretes to Success at Work](https://jackwelch.strayer.edu/winning/six-secrets-work-success/)
...
- supported by USA Quality Improvement Act
- awarded by SUA president for quality
...
- [Malcolm Baldrige National Quality Award](https://en.wikipedia.org/wiki/Malcolm_Baldrige_National_Quality_Award#Baldrige_Award_Recipients) - paid documents, cheap, but still $$$[American Society for Quality](https://asq.org/quality-resources/malcolm-baldrige-national-quality-award).
...
TQM
W.Deming 14-Points
https://www.youtube.com/watch?v=tsF-8u-V4j4&t=400s&ab_channel=DemingInstitute
...
- Jokes Deming liked; *Murphy was an optimist...*
...
# Blogs
- [Allen Holub - Agility - Essential Reading](https://holub.com/reading/)
- Two primary practices are to visualize your work and to limit work in progress (WIP)
- Kanban metrics include:
  - Team velocity defines how many tasks a team can deliver in a given period of time, for example a week or iteration.
  - Lead and Cycle time defines the average time it takes to complete a task.
  - Actionable Agile metrics use cycle time to better predict when each project item is going to be finished. [recent: 2015 concept]

  [ ] - see [Software Development Methodologies](https://en.wikipedia.org/wiki/List_of_software_development_philosophies)
