What are open data standards?  What is Canada's statement on open data standards?  If a guideline were to say "use open data standards" what would that mean to a developer, business user or client?
